...
By "modern computer", we mean your personal computer running, e.g., Linux Mint 20.1.

### What do you need?

  * A modern Python, i.e., version >= 3.8,
  ...
  * The Python dependencies from `itu-minitwit`:
    - [Flask](https://flask.palletsprojects.com/en/1.1.x/) >= version 1.1
      - [Werkzeug](https://palletsprojects.com/p/werkzeug/) >= version 1.0
      - [Jinja2](https://palletsprojects.com/p/jinja/) >= version 2.11
...
## 4) Share your Work on Github
  ...
  - Once you are done (and latest by **Sunday Feb 7th, at 22:00**) [create a release](https://help.github.com/en/github/administering-a-repository/creating-releases) with your refactored version of _ITU-MiniTwit_.


Please share your repositories with us. Send a Github pull-request on the file [`repositories.py`](https://github.com/itu-devops/lecture_notes/blob/master/repositories.py) in which you replace, e.g., `"https://github.com/<TBA>"` with your repository URL of your group. In case you use more than one repository, please add them to the corresponding list too.
