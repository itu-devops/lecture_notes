...
|link:https://github.com/itu-devops/lecture_notes/blob/master/sessions/session_02/Session%203.ipynb[Virtualization via containers and virtual machines]
...
* link:http://157.230.24.69/commit_activity_daily.svg[Daily commit activity
per group]
* link:http://157.230.24.69/commit_activity_weekly.svg[Weekly commit
activity per group]
* link:http://157.230.24.69/release_activity_weekly.svg[Weekly release
activity per group]
