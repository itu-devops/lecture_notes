...
|link:https://github.com/itu-devops/lecture_notes/blob/master/sessions/session_04/Slides.md[*Guest Lecture Eficode: What is DevOps?*; Continuous Integration (CI), Continuous Delivery (CD), and Continuous Deployment]
...
|
|Cleaning and polishing of your _ITU-MiniTwit_, introduction of DB abstraction layer, and entering maintenance (*Simulator starts*)
