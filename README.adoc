...
|link:https://github.com/itu-devops/lecture_notes/blob/master/sessions/session_04/Slides.md[*Guest Lecture Eficode*; Continuous Integration (CI), Continuous Delivery (CD), and Continuous Deployment]
